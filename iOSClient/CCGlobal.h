...
// Session
#define k_domain_session_queue                          @"com.spreedbox.Crypto-Cloud"

#define k_download_session                              @"com.spreedbox.Crypto-Cloud.download.session"
#define k_download_session_foreground                   @"com.spreedbox.Crypto-Cloud.download.sessionforeground"
#define k_download_session_wwan                         @"com.spreedbox.Crypto-Cloud.download.sessionwwan"
#define k_upload_session                                @"com.spreedbox.Crypto-Cloud.upload.session"
#define k_upload_session_foreground                     @"com.spreedbox.Crypto-Cloud.upload.sessionforeground"
#define k_upload_session_wwan                           @"com.spreedbox.Crypto-Cloud.upload.sessionwwan"

// OperationQueue
#define k_queue                                         @"com.spreedbox.Crypto-Cloud.queue"
#define k_download_queue                                @"com.spreedbox.Crypto-Cloud.download.queue"
#define k_download_queuewwan                            @"com.spreedbox.Crypto-Cloud.download.queuewwan"
#define k_upload_queue                                  @"com.spreedbox.Crypto-Cloud.upload.queue"
#define k_upload_queuewwan                              @"com.spreedbox.Crypto-Cloud.upload.queuewwan"

// Service Key Share
#define k_serviceShareKeyChain                          @"Crypto Cloud"
#define k_metadataKeyedUnarchiver                       @"com.spreedbox.nextcloud.metadata"
