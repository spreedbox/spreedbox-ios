...
- (id<STNetworkOperation>)getServerConfigWithServer:(NSString *)server withCompletionBlock:(GetServerConfigCompletionBlock)block
{
	...
	AFHTTPSessionManager *httpRequestOpManager = [[AFHTTPSessionManager alloc] init];
    ...
    NSURLSessionTask *op = [httpRequestOpManager GET:server parameters:@{} success:^(NSURLSessionTask *operation, id responseObject) {
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
            NSDictionary *spreedWebRTCService = [responseObject objectForKey:kServerConfigSpreedWebRTCKey];
            ...
            if ([responseObject objectForKey:kServerConfigVersionKey]) {
                _serverConfig = responseObject;
        ...
        if ([error isKindOfClass:[NSDictionary class]]) {
            /*NSString *ownCloudServiceMessage = [error objectForKey:kServerConfigOwnCloudMessageKey];
...
- (id<STNetworkOperation>)getRandomRoomNameGeneratedByServer:(NSString *)server withCompletionBlock:(GetRandomRoomCompletionBlock)block
{
	...
	NSURLSessionTask *op = [httpRequestOpManager POST:server parameters:@{} success:^(NSURLSessionTask *operation, id responseObject) {
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
...
- (id<STNetworkOperation>)discoverServicesFromServer:(NSString *)server withCompletionBlock:(GetServerConfigCompletionBlock)block
{
    ...
    NSURLSessionTask *op = [httpRequestOpManager GET:server parameters:nil success:^(NSURLSessionTask *operation, id responseObject) {
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
            _servicesConfig = responseObject;
...
- (id<STNetworkOperation>)getTemporaryPaswordGeneratedByServer:(NSString *)server forName:(NSString *)name andExpirationDate:(NSString *)expiration withCompletionBlock:(GetTemporaryPasswordCompletionBlock)block
{
    ...
    NSURLSessionTask *op = [httpRequestOpManager POST:server parameters:parameters success:^(NSURLSessionTask *operation, id responseObject) {
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
            NSDictionary *serverResponse = responseObject;
...
- (id<STNetworkOperation>)getLEDConfigurationWithAccessToken:(NSString *)accessToken andCompletionBlock:(GetLEDConfigCompletionBlock)block
{
    ...
    // We add an empty dictionary as parameter in order to make AFHTTPRequestSerializer set application/x-www-form-urlencoded as content type.
    NSURLSessionTask *op = [httpRequestOpManager GET: ledControlEndpoint parameters:@{} success:^(NSURLSessionTask *operation, id responseObject) {
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
            NSDictionary *serverResponse = responseObject;
...
- (id<STNetworkOperation>)setLEDConf:(NSDictionary *)config withAccessToken:(NSString *)accessToken andCompletionBlock:(GetLEDConfigCompletionBlock)block
{
    ...
    NSURLSessionTask *op = [httpRequestOpManager POST:ledControlEndpoint parameters:config success:^(NSURLSessionTask *operation, id responseObject) {
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
            NSDictionary *serverResponse = responseObject;
            NSDictionary *resultDict = [serverResponse objectForKeyedSubscript:@"result"];
            if (complBlock) {
...
- (id<STNetworkOperation>)previewLEDStateConfiguration:(NSDictionary *)config withAccessToken:(NSString *)accessToken andCompletionBlock:(GetLEDConfigCompletionBlock)block
{
    ...
    NSURLSessionTask *op = [httpRequestOpManager PUT:ledControlEndpoint parameters:config success:^(NSURLSessionTask *operation, id responseObject) {
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
            NSDictionary *serverResponse = responseObject;
            NSDictionary *resultDict = [serverResponse objectForKeyedSubscript:@"result"];
            if (complBlock) {
